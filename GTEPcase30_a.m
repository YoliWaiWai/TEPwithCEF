...
cei = [0.905,0.905,0.746,0.746]*1e2;%碳排放强度 单位：t/MWh
...
Cons = [Cons, x_gens <= repmat(x_coal_max', 1, Years)];
%投资状态变量
for year = 1:Years
    if year == 1
        % 第一年
...
for y = 1:Years
    for h = 1:Hours
        ...
        Cons = [Cons,In * p(:,h,y) == sum_N_g(:,h,y) + g_exist(:,h,y) - (P_load(:,h,y) - pd_shed(:,h,y)) ];
...
% 创建按钮回调函数
set(year1Button, 'Callback', @(src, event) plotResults(1,Hours,s_Obj_ope,s_sum_type_g,s_g_exist,s_pd_shed,P_load,s_I_lines,s_x_gen_coal_1,s_x_gen_coal_2,s_x_gen_coal_3,s_x_gen_coal_4,I,J,l_E));
set(year2Button, 'Callback', @(src, event) plotResults(2,Hours,s_Obj_ope,s_sum_type_g,s_g_exist,s_pd_shed,P_load,s_I_lines,s_x_gen_coal_1,s_x_gen_coal_2,s_x_gen_coal_3,s_x_gen_coal_4,I,J,l_E));
set(year3Button, 'Callback', @(src, event) plotResults(3,Hours,s_Obj_ope,s_sum_type_g,s_g_exist,s_pd_shed,P_load,s_I_lines,s_x_gen_coal_1,s_x_gen_coal_2,s_x_gen_coal_3,s_x_gen_coal_4,I,J,l_E));
set(year4Button, 'Callback', @(src, event) plotResults(4,Hours,s_Obj_ope,s_sum_type_g,s_g_exist,s_pd_shed,P_load,s_I_lines,s_x_gen_coal_1,s_x_gen_coal_2,s_x_gen_coal_3,s_x_gen_coal_4,I,J,l_E));
set(year5Button, 'Callback', @(src, event) plotResults(5,Hours,s_Obj_ope,s_sum_type_g,s_g_exist,s_pd_shed,P_load,s_I_lines,s_x_gen_coal_1,s_x_gen_coal_2,s_x_gen_coal_3,s_x_gen_coal_4,I,J,l_E));